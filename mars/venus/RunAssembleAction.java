	...
	public void actionPerformed(ActionEvent e) {
		...
		if (FileStatus.getFile() != null) {
			...
			try {
				...
				// added logic to receive any warnings and output them.... 11/28/06
				...
				for (int i = 0; i < errorMessages.size(); i++) {
					...
					// No line or position may mean File Not Found (e.g. exception file). Don't try to open. 3-Oct-2010
