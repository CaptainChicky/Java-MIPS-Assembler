...
public class FilenameFinder {
	...
	public static ArrayList<String> getFilenameList(ClassLoader classLoader,
		...
		// Modified 10-July-2008 to better handle path containing space
		// character (%20) and to hopefully handle path containing non-ASCII
		// characters.  The "toURI()" approach was suggested and 
		// worked for him when running 'java Mars' but it did
		...
		// new URI from the resulting string, it works!
		//
		...
		//
		// Modified 24-Sept-2009 to handle multiple JAR files.
