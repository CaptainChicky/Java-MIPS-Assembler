...
public abstract class AbstractMarsToolAndApplication extends JFrame implements MarsTool, Observer {
		...
		openFileButton.addActionListener(
				new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						// 13 June 2007.  The next 4 lines add file filter to file chooser.
	...
	*/
	...
	protected class ConnectButton extends JButton {
		...
		public void connect() {
			observing = true;
			synchronized (Globals.memoryAndRegistersLock) // 23 July 2008
			{
				addAsObserver();
			}
	...
	private class CreateAssembleRunMIPSprogram implements Runnable {
		public void run() {
			...
			// Moved these three register resets from before the try block to after it.  17-Dec-09
